...
// Copyright (c) 2014 The TribusCoin developers
...
const string strMessageMagic = "TribusCoin Signed Message:\n";
...
static const int64 RewardsChangeEQ = 15 * sin(100 * nHeight) - (1/31536) * nHeight + 100 * COIN;

int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = RewardsChangeEQ;
...
static const int64 nTargetTimespan = 40;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TribusCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TribusCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TribusCoin miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    ...
    {
        printf("TribusCoin miner terminated\n");
        throw;
    }
}
